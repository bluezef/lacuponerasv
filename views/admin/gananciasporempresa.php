                    ...
                    <?php if ($result->rowCount() > 0){ 
                        ...
                        <?php while ($row = $result->fetch(PDO::FETCH_OBJ)): ?>
                            <tr>
                                ...
                                <td>$<?php echo ($row->porcentaje*$row->montoventas)/100; ?></td>
                            </tr>
                        <?php 
                        $ventas_total+= $row->montoventas;
                        $ganancia_total+=($row->porcentaje*$row->montoventas)/100; 
                        endwhile; ?>
                            <tr>
                                <td><b>Totales:</b></td>
                                <td><b></b></td>
                                <td><b>$<?php echo $ventas_total; ?></b></td>
                                <td><b>$<?php echo $ganancia_total; ?></b></td>
                            </tr>
                    <?php }else{  ?>
                        <tr>
